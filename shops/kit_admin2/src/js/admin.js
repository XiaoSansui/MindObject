var mods = [
  ...
  'tabs', 'menu', 'route', 'utils', 'component', 'kit','form',
];
    ...
    routeInit: function(config) {
      ...
      var routeOpts = {
        ...
        routes: [{
          ...
          path: '/mygoods',
          component: 'pages/MyGoods.html',
          name: '我的商品',
          iframe: true
        },{
          path: '/myshops',
          component: 'pages/MyShops.html',
          name: '店铺管理',
          iframe: true
        },{
          path: '/myassets',
          component: 'pages/MyAssets.html',
          name: '资产管理',
          iframe: true
        },{
          path: '/myonlines',
          component: 'pages/MyOnlines.html',
          name: '上线管理',
          iframe: true
        },{
          path: '/mystaffs',
          component: 'pages/MyStaffs.html',
          name: '员工管理',
          iframe: true
        },{
          path: '/myorders',
          component: 'pages/MyOrders.html',
          name: '订单管理',
          iframe: true
        },{
          path: '/exception/403',
