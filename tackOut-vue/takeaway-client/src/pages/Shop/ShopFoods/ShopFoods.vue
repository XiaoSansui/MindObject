  ...
  <div>
    <div class="goods">
      ...
      <div class="foods-wrapper" ref="foodsWrapper">
        <ul ref="foodsUL">
          <li class="food-list-hook" v-for="(goods,index) in foods" :key="index">
            <h1 class="title">{{goods.name}}</h1>
            <ul>
              <li class="food-item bottom-border-1px" v-for="(good,index) in goods.foods"
                  :key="index" @click="foodShow(good)">
                <div class="icon">
...
<script>
  ...
  import CartControl from '../../../compoents/CartControl/CartControl'
  import Food from '../../../compoents/Food/Food'
  import ShopCart from '../../../compoents/ShopCart/ShopCart'
  ...
  export default {
    ...
    methods:{
      ...
      clickMenuItem(index){
        ...
        //平滑滑动右侧列表
        this.foodsScroll.scrollTo(0,-scrollY,250)
      },
      //显示food
      foodShow(food){
        this.food = food
