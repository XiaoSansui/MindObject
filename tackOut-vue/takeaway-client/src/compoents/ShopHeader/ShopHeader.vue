<template>
    <div class="shop-header">
      ...
      <div class="shop-header-discounts" @click="toggleShowActivity" v-if="info.supports">
      ...
      <transition name="fade">
        ...
        <span class="mini-tag">品牌</span>
          ...
          <div class="brief-modal-cover" @click="toggleShowShop"></div>
        </div>
      </transition>
      <transition name="fade">
        <div class="activity-sheet" v-show="showActivity" v-if="info.supports">
          <div class="activity-sheet-content">
            <h2 class="activity-sheet-title">优惠活动</h2>
            <ul class="list">
              <li class="activity-item"  :class="activityClass[info.supports[0].type]">
          <span class="content-tag">
          <span class="mini-tag">{{info.supports[0].name}}</span>
          </span>
                <span class="activity-content">{{info.supports[0].content}}</span>
              </li>
              <li class="activity-item"  :class="activityClass[info.supports[1].type]">
            <span class="content-tag">
            <span class="mini-tag">{{info.supports[1].name}}</span>
              </span>
                <span class="activity-content">{{info.supports[1].content}}</span>
              </li>
              <li class="activity-item"  :class="activityClass[info.supports[2].type]">
            <span class="content-tag">
            <span class="mini-tag">{{info.supports[2].name}}</span>
            </span>
                <span class="activity-content">{{info.supports[2].content}}</span>
              </li>
              <li class="activity-item" :class="activityClass[info.supports[3].type]">
            <span class="content-tag">
            <span class="mini-tag">{{info.supports[3].name}}</span>
            </span>
                <span class="activity-content">{{info.supports[3].content}}</span>
              </li>
              <li class="activity-item" :class="activityClass[info.supports[4].type]">
            <span class="content-tag">
            <span class="mini-tag">{{info.supports[4].name}}</span>
            </span>
                <span class="activity-content">{{info.supports[4].content}}</span>
              </li>
              <li class="activity-item" :class="activityClass[info.supports[5].type]">
            <span class="content-tag">
          ...
          <div class="activity-sheet-cover" @click="toggleShowActivity"></div>
        </div>
      </transition>
    </div>
</template>
...
<script>
  ...
  export default {
    data(){
      return{
        showShop:false, //显示商户详细信息
        showActivity:false, //显示活动列表
